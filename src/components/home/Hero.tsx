...
export function Hero() {
  return (
    <section className="relative w-full py-12 sm:py-16 lg:py-20 overflow-hidden bg-background">
      {/* Decorative divine aura background glows */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-burgundy/10 dark:border-white/10 w-full grid grid-cols-3 gap-2 sm:gap-6 text-center lg:text-left">
              <div>
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold font-serif text-burgundy dark:text-amber-200">
                  4+
                </div>
                <div className="text-xs sm:text-sm text-foreground/70 mt-0.5">
                  Categories
                </div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold font-serif text-saffron">
                  Grand
                </div>
                <div className="text-xs sm:text-sm text-foreground/70 mt-0.5">
                  Prizes & Awards
          ...
          {/* Right Column - Lord Ganesha Image Showcase */}
          <motion.div
          ...
          >
            {/* Glowing Golden Aura behind the image */}
            ...
            <motion.div
              ...
              className="relative w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[420px] aspect-[2/3] rounded-3xl overflow-hidden border-2 border-amber-400/50 dark:border-amber-400/40 shadow-2xl shadow-saffron/25 group"
            >
              <Image
              ...
              {/* Gradient overlay at bottom for depth and text legibility */}
